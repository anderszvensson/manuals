;; $Id: dbindex.dsl,v 1.1 2003/07/13 18:29:47 jaromil Exp $
;;
...
(define (indexentry-link nd)
  (let* ((indexid        (attribute-string (normalize "role") nd))
	 (target    (find-indexterm indexid))
